...
class EventController extends AbstractController
{
    ...
    public function Addevent(Request $request ,MailerInterface $mailer, FlashyNotifier $flashy): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()){
            ...
            $twilio->sendSMS('+21699474824',' Event added successfully');
            $email->sendEmail($mailer,'testapimail63@gmail.com','bayrem.hamdi@esprit.tn','testing email','Event added successfully');
            $this->addFlash(
